...
public class AndroidWifiModule extends ReactContextBaseJavaModule {
  ...
  public void forceWifiUsage(boolean useWifi) {
        ...
        if (useWifi) {
            // Object sdkInteger = Build.VERSION.SDK_INT; // 23, 25, etc.
            Object releaseString = Build.VERSION.RELEASE; // 7.1.1, 6.0.1, 9, etc.
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {

                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    canWriteFlag = true;
                    // Only need ACTION_MANAGE_WRITE_SETTINGS on 6.0.0, regular permissions suffice on 7+
                    ...
                    // On M 6.0.0 (N+ or higher and 6.0.1 already hit, we need ACTION_MANAGE_WRITE_SETTINGS here.
